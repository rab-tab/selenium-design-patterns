...
public class Decorators {
    static void shouldDisplay(List<WebElement> elems)
    {
        elems.forEach(element-> Assert.assertTrue(element.isDisplayed()));
    }

    static void shouldNotDisplay(List<WebElement> elems)
    {
        elems.forEach(element-> Assert.assertFalse(element.isDisplayed()));
    }
